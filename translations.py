...
translations = {
    'en': {
        ...
        'menu_contact_developer': 'Write to Owner',
        ...
        'feedback_placeholder_drag': 'Your message... (drag files or images here or use Ctrl+V)',
        ...
        'success': 'Success',
        'error': 'Error',
        'contact_developer': 'Write to Owner',
        'email_optional': 'Email (optional):',
        'send_message': 'Send Message',
        'please_enter_message': 'Please enter a message',
        'error_occurred': 'Error Occurred',
        'send_error_report_prompt': 'An error occurred during processing. Would you like to send an error report to the owner?',
    ...
    'ru': {
        ...
        'menu_contact_developer': 'Написать хозяину',
        ...
        'feedback_placeholder_drag': 'Ваше сообщение... (перетащите файлы или изображения или Ctrl+V)',
        ...
        'success': 'Успешно',
        'error': 'Ошибка',
        'contact_developer': 'Написать хозяину',
        'email_optional': 'Email (необязательно):',
        'send_message': 'Отправить сообщение',
        'please_enter_message': 'Пожалуйста, введите сообщение',
        'error_occurred': 'Произошла ошибка',
        'send_error_report_prompt': 'При обработке произошла ошибка. Хотите отправить отчет об ошибке хозяину?',
